 ...
 * Key pattern: premium:sad:{shopId}
 * Value: { subscriptionId, email, ownerEmail, since, expiresAt, active }
 *
 ...
 *
 * ownerEmail: optional store owner email used to forward leads directly.
 */

const KV_PREFIX = 'premium:sad';
const PREMIUM_DAYS = 32; // slight buffer over 30 days
