    ...
    <div style={{minHeight:"100vh",background:"#F9FAFB",fontFamily:"'DM Sans',system-ui,sans-serif"}}>
      ...
      <div style={{maxWidth:680,margin:"0 auto",padding:"32px 20px 48px"}}>
        ...
        <div style={{fontSize:15,color:"#374151",lineHeight:1.8}}>
          ...
          <p>ScratchAndDentGuide.com is a free, searchable directory of <strong>728+ verified scratch and dent appliance stores across 51 US states.</strong> We built this site for one reason: to make it easy for everyday shoppers to find nearby stores that sell discounted appliances &mdash; without spending hours searching Google, calling around, or driving to stores that turned out to be something else entirely.</p>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:12,margin:"16px 0"}}>
            {[["728+","Verified store listings"],["51","US states covered"],["100%","Free to use"],["0","Sponsored or paid listings"]].map(([n,l])=>(
