  ...
  if (success) {
    return (
      <div style={{ maxWidth: 520, margin: '60px auto', padding: '0 24px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: 26, fontWeight: 800, color: '#0F172A', margin: '0 0 12px' }}>Payment successful!</h2>
        ...
        <div style={{ background: '#F0FDF4', border: '1px solid #BBF7D0', borderRadius: 10, padding: 20, textAlign: 'left' }}>
          <p style={{ margin: 0, fontSize: 14, color: '#166534', fontWeight: 600 }}>Your Premium benefits:</p>
          <ul style={{ margin: '8px 0 0', paddingLeft: 20, color: '#166534', fontSize: 14, lineHeight: 2 }}>
