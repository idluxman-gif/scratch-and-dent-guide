...
export async function POST(request) {
  try {
    ...
    const checkoutUrl = `https://app.gumroad.com/checkout?product=${encodeURIComponent(productId)}&wanted=true&custom_fields[shop_id]=${encodeURIComponent(shopId)}&custom_fields[shop_name]=${encodeURIComponent(shopName)}&custom_fields[site]=scratchanddent`;
