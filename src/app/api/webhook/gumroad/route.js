...
/**
 * Gumroad webhook handler for Scratch & Dent Guide.
 *
 * NOTE: Gumroad only supports a single "Ping" endpoint, which is currently
 * set to ShieldFinder. That hub handler processes events for BOTH sites.
 * This endpoint exists as a backup / direct-call option and handles
 * both sites identically to the SF hub.
 *
 * KV prefixes:
